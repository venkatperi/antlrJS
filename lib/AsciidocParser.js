...
var symbolicNames = [ null, "SECTION_END", "H0", "ATTR_BEGIN", "PPD_START", 
                      "COMMENT", "END_OF_HEADER", "EOL", "WS", "DOCTITLE_CSP", 
                      "DOCTITLE_PART", "DOCTITLE_EOL", "AUTHOR_NAME", "AUTHOR_CONTACT", 
                      "AUTHOR_SEP", "AUTHOR_EOL", "AUTHOR_WS", "REV_NUMPREFIX", 
                      "REV_NUMBER", "REV_COMMA", "REV_COLON", "REV_EOL", 
                      "REV_DATE", "REV_REMARK", "ATTR_ID", "ATTR_UNSET", 
                      "ATTR_SEP", "ATTR_VALUE", "ATTR_EOL", "SECTITLE_TEXT", 
                      "SECTITLE_EOL", "SECTITLE_START", "BLOCK_ANCHOR", 
                      "BLOCK_ATTR_START", "BLOCK_TITLE_START", "BLOCK_PARA", 
                      "BLOCK_COMMENT", "BLOCK_EOP", "BLOCK_TABLE_START", 
                      "BLOCK_ANON_START", "BLOCK_COMMENT_START", "BLOCK_EXAMPLE_START", 
                      "BLOCK_FENCED_START", "BLOCK_LISTING_START", "BLOCK_LITERAL_START", 
                      "BLOCK_PASS_START", "BLOCK_SIDEBAR_START", "BLOCK_VERSE_START", 
                      "BLOCK_ATTR_ID", "BLOCK_ATTR_COMMA", "BLOCK_ATTR_ASSIGN", 
                      "BLOCK_ATTR_TYPE_ROLE", "BLOCK_ATTR_TYPE_OPTION", 
...
AsciidocParser.H0 = 2;
AsciidocParser.ATTR_BEGIN = 3;
AsciidocParser.PPD_START = 4;
AsciidocParser.COMMENT = 5;
AsciidocParser.END_OF_HEADER = 6;
AsciidocParser.EOL = 7;
AsciidocParser.WS = 8;
AsciidocParser.DOCTITLE_CSP = 9;
AsciidocParser.DOCTITLE_PART = 10;
AsciidocParser.DOCTITLE_EOL = 11;
AsciidocParser.AUTHOR_NAME = 12;
AsciidocParser.AUTHOR_CONTACT = 13;
AsciidocParser.AUTHOR_SEP = 14;
AsciidocParser.AUTHOR_EOL = 15;
AsciidocParser.AUTHOR_WS = 16;
AsciidocParser.REV_NUMPREFIX = 17;
AsciidocParser.REV_NUMBER = 18;
AsciidocParser.REV_COMMA = 19;
AsciidocParser.REV_COLON = 20;
AsciidocParser.REV_EOL = 21;
AsciidocParser.REV_DATE = 22;
AsciidocParser.REV_REMARK = 23;
AsciidocParser.ATTR_ID = 24;
AsciidocParser.ATTR_UNSET = 25;
AsciidocParser.ATTR_SEP = 26;
AsciidocParser.ATTR_VALUE = 27;
AsciidocParser.ATTR_EOL = 28;
AsciidocParser.SECTITLE_TEXT = 29;
AsciidocParser.SECTITLE_EOL = 30;
AsciidocParser.SECTITLE_START = 31;
AsciidocParser.BLOCK_ANCHOR = 32;
AsciidocParser.BLOCK_ATTR_START = 33;
AsciidocParser.BLOCK_TITLE_START = 34;
AsciidocParser.BLOCK_PARA = 35;
AsciidocParser.BLOCK_COMMENT = 36;
AsciidocParser.BLOCK_EOP = 37;
AsciidocParser.BLOCK_TABLE_START = 38;
AsciidocParser.BLOCK_ANON_START = 39;
AsciidocParser.BLOCK_COMMENT_START = 40;
AsciidocParser.BLOCK_EXAMPLE_START = 41;
AsciidocParser.BLOCK_FENCED_START = 42;
AsciidocParser.BLOCK_LISTING_START = 43;
AsciidocParser.BLOCK_LITERAL_START = 44;
AsciidocParser.BLOCK_PASS_START = 45;
AsciidocParser.BLOCK_SIDEBAR_START = 46;
AsciidocParser.BLOCK_VERSE_START = 47;
AsciidocParser.BLOCK_ATTR_ID = 48;
AsciidocParser.BLOCK_ATTR_COMMA = 49;
AsciidocParser.BLOCK_ATTR_ASSIGN = 50;
AsciidocParser.BLOCK_ATTR_TYPE_ROLE = 51;
AsciidocParser.BLOCK_ATTR_TYPE_OPTION = 52;
AsciidocParser.BLOCK_ATTR_TYPE_ID = 53;
AsciidocParser.BLOCK_ATTR_UNSET = 54;
AsciidocParser.BLOCK_ATTR_END = 55;
AsciidocParser.BLOCK_ATTR_EOL = 56;
AsciidocParser.BLOCK_ATTR_VALUE = 57;
AsciidocParser.BLOCK_TITLE_TEXT = 58;
AsciidocParser.BLOCK_TITLE_EOL = 59;
AsciidocParser.PPD_ATTR_ID = 60;
AsciidocParser.PPD_ATTR_SEP = 61;
AsciidocParser.PPD_CONTENT_SINGLELINE = 62;
AsciidocParser.PPD_CONTENT_START = 63;
AsciidocParser.PPD_CONTENT = 64;
AsciidocParser.DELIM_BLOCK_LINE = 65;
AsciidocParser.DELIM_BLOCK_END = 66;
...
AsciidocParser.prototype.asciidoc = function() {
    ...
    try {
        ...
        while(((((_la - 31)) & ~0x1f) == 0 && ((1 << (_la - 31)) & ((1 << (AsciidocParser.SECTITLE_START - 31)) | (1 << (AsciidocParser.BLOCK_ANCHOR - 31)) | (1 << (AsciidocParser.BLOCK_ATTR_START - 31)))) !== 0)) {
            this.state = 119;
            this.section();
            this.state = 124;
            this._errHandler.sync(this);
...
AsciidocParser.prototype.author_rev = function() {
    ...
    try {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        if((((_la) & ~0x1f) == 0 && ((1 << _la) & ((1 << AsciidocParser.REV_NUMPREFIX) | (1 << AsciidocParser.REV_NUMBER) | (1 << AsciidocParser.REV_COLON) | (1 << AsciidocParser.REV_EOL) | (1 << AsciidocParser.REV_DATE))) !== 0)) {
            this.state = 147;
            this.revision();
        }
...
AsciidocParser.prototype.preamble = function() {
    ...
    try {
        ...
        this._errHandler.sync(this);
        _la = this._input.LA(1);
        while(((((_la - 32)) & ~0x1f) == 0 && ((1 << (_la - 32)) & ((1 << (AsciidocParser.BLOCK_ANCHOR - 32)) | (1 << (AsciidocParser.BLOCK_ATTR_START - 32)) | (1 << (AsciidocParser.BLOCK_TITLE_START - 32)) | (1 << (AsciidocParser.BLOCK_PARA - 32)) | (1 << (AsciidocParser.BLOCK_TABLE_START - 32)) | (1 << (AsciidocParser.BLOCK_ANON_START - 32)) | (1 << (AsciidocParser.BLOCK_COMMENT_START - 32)) | (1 << (AsciidocParser.BLOCK_EXAMPLE_START - 32)) | (1 << (AsciidocParser.BLOCK_FENCED_START - 32)) | (1 << (AsciidocParser.BLOCK_LISTING_START - 32)) | (1 << (AsciidocParser.BLOCK_LITERAL_START - 32)) | (1 << (AsciidocParser.BLOCK_PASS_START - 32)) | (1 << (AsciidocParser.BLOCK_SIDEBAR_START - 32)) | (1 << (AsciidocParser.BLOCK_VERSE_START - 32)))) !== 0)) {
            this.state = 248;
            this.body_item();
            this.state = 253;
            this._errHandler.sync(this);
...
Section_headerContext.prototype.SECTITLE_START = function() {
    return this.getToken(AsciidocParser.SECTITLE_START, 0);
};
...
Section_headerContext.prototype.SECTITLE_EOL = function() {
    return this.getToken(AsciidocParser.SECTITLE_EOL, 0);
};
...
AsciidocParser.prototype.section_header = function() {
    ...
    try {
        ...
        this.state = 266;
        this.match(AsciidocParser.SECTITLE_START);
        this.state = 267;
        this.section_title();
        this.state = 268;
        this.match(AsciidocParser.SECTITLE_EOL);
    } catch (re) {
    	if(re instanceof antlr4.error.RecognitionException) {
	        localctx.exception = re;
	        this._errHandler.reportError(this, re);
...
Section_titleContext.prototype.SECTITLE_TEXT = function() {
    return this.getToken(AsciidocParser.SECTITLE_TEXT, 0);
};
...
AsciidocParser.prototype.section_title = function() {
    ...
    try {
        this.enterOuterAlt(localctx, 1);
        this.state = 270;
        this.match(AsciidocParser.SECTITLE_TEXT);
    } catch (re) {
    	if(re instanceof antlr4.error.RecognitionException) {
	        localctx.exception = re;
	        this._errHandler.reportError(this, re);
